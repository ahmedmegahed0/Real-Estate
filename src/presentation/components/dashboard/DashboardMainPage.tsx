    ...
    <div className="animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
        ...
        <div className="flex items-center space-x-4">
          <div className="hidden md:block text-right rtl:text-left">
            ...
            <div className="text-xs text-white/40">{t('dashboard.realTime')}</div>
          </div>
          <button 
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-widest text-white">{t('dashboard.refresh')}</span>
          </button>
        </div>
      </div>
      ...
      {error ? (
        <div className="p-6 mb-8 border-l-4 border-red-500/50 bg-red-500/10 text-red-400 rounded-r-2xl text-sm font-medium flex items-center space-x-3">
          ...
          <div>
            <div className="font-bold">{t('dashboard.errorLoading')}</div>
