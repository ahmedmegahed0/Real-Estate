...
export function SettingsPage() {
  ...
  return (
    <div className="animate-in fade-in duration-700">
      <div className="mb-12">
        <h2 className="text-3xl md:text-4xl font-['Playfair_Display'] text-white mb-2">Website Settings</h2>
        <p className="text-xs md:text-sm font-['Inter'] text-white/40 tracking-wide">Configure your platform's global settings and contact information.</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-10 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="space-y-10">
              <div className="relative group">
                ...
                <label htmlFor="siteName" className="absolute text-[10px] tracking-[0.2em] font-semibold uppercase text-white/40 duration-300 transform -translate-y-4 top-5 z-10 origin-[0] peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-4 peer-focus:text-[#C8A96A]">Site Name *</label>
              </div>
              ...
              <div className="relative group">
                ...
                <label htmlFor="siteDescription" className="absolute text-[10px] tracking-[0.2em] font-semibold uppercase text-white/40 duration-300 transform -translate-y-4 top-5 z-10 origin-[0] peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-4 peer-focus:text-[#C8A96A]">Site Description *</label>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="relative group">
                  ...
                  <label htmlFor="contactEmail" className="absolute text-[10px] tracking-[0.2em] font-semibold uppercase text-white/40 duration-300 transform -translate-y-4 top-5 z-10 origin-[0] peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-4 peer-focus:text-[#C8A96A]">Contact Email *</label>
                </div>
                <div className="relative group">
                  ...
                  <label htmlFor="contactPhone" className="absolute text-[10px] tracking-[0.2em] font-semibold uppercase text-white/40 duration-300 transform -translate-y-4 top-5 z-10 origin-[0] peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-4 peer-focus:text-[#C8A96A]">Contact Phone *</label>
                </div>
              </div>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white/5 p-6 rounded-2xl border border-white/5 flex items-center justify-between">
                <div>
                  <h4 className="text-white text-sm font-semibold mb-1">Maintenance Mode</h4>
                  <p className="text-white/40 text-xs">Temporarily disable public access to the website.</p>
                </div>
          ...
          <div className="pt-6 border-t border-white/5 flex justify-end">
            ...
            >
              ...
              <span>{isUpdating ? 'Saving Changes...' : 'Save Settings'}</span>
              {!isUpdating && <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:translate-x-1 transition-transform"><polyline points="9 18 15 12 9 6"></polyline></svg>}
            </button>
          </div>
