  ...
  return (
    <div className="animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:justify-between md:items-end gap-6 mb-12">
        <div>
          <h2 className="text-3xl md:text-4xl font-['Playfair_Display'] text-white mb-2">Projects Portfolio</h2>
          <p className="text-xs md:text-sm font-['Inter'] text-white/40 tracking-wide">Manage your luxury real estate listings</p>
        </div>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center py-40 border border-white/5 border-dashed rounded-3xl bg-white/[0.02]">
          ...
          <div className="text-white/40 font-['Inter'] text-sm tracking-wide">No projects found. Start building your portfolio.</div>
        </div>
      ) : (
