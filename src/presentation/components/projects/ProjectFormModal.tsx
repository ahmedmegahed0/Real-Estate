  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-4xl bg-gradient-to-b from-[#1a1a1a]/90 to-[#0a0a0a]/90 backdrop-blur-2xl border border-white/10 rounded-[2rem] shadow-[0_0_80px_rgba(200,169,106,0.15)] max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-500">
        ...
        <div className="p-8 border-b border-white/5 flex justify-between items-center relative z-20">
          <div>
            <h2 className="text-3xl font-['Playfair_Display'] text-transparent bg-clip-text bg-gradient-to-r from-[#C8A96A] to-[#E5D09C] mb-1">
              {projectToEdit ? 'Edit Residence' : 'Add New Residence'}
            </h2>
            <p className="text-white/40 text-xs font-['Inter'] tracking-[0.2em] uppercase">Curate your exclusive portfolio</p>
          </div>
          ...
          <form id="project-form" onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="relative group">
                ...
                <label htmlFor="name" className="absolute text-[10px] tracking-[0.2em] font-semibold uppercase text-white/40 duration-300 transform -translate-y-4 top-5 z-10 origin-[0] peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-4 peer-focus:text-[#C8A96A]">Project Name *</label>
              </div>
              <div className="relative group">
                ...
                <label htmlFor="location" className="absolute text-[10px] tracking-[0.2em] font-semibold uppercase text-white/40 duration-300 transform -translate-y-4 top-5 z-10 origin-[0] peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-4 peer-focus:text-[#C8A96A]">Location *</label>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <label htmlFor="shortDescription" className="absolute text-[10px] tracking-[0.2em] font-semibold uppercase text-white/40 duration-300 transform -translate-y-4 top-5 z-10 origin-[0] peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-4 peer-focus:text-[#C8A96A]">Short Description *</label>
            </div>
            ...
            <div className="relative group">
              ...
              <label htmlFor="fullDescription" className="absolute text-[10px] tracking-[0.2em] font-semibold uppercase text-white/40 duration-300 transform -translate-y-4 top-5 z-10 origin-[0] peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-4 peer-focus:text-[#C8A96A]">Full Description *</label>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="relative group">
                ...
                <label htmlFor="whatsappNumber" className="absolute text-[10px] tracking-[0.2em] font-semibold uppercase text-white/40 duration-300 transform -translate-y-4 top-5 z-10 origin-[0] peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-4 peer-focus:text-[#C8A96A]">WhatsApp Number *</label>
              </div>
              <div className="relative group">
                <input required type="text" name="phoneNumber" id="phoneNumber" placeholder=" " value={formData.phoneNumber} onChange={handleChange} className="block w-full px-0 py-3 pt-6 text-white bg-transparent border-0 border-b border-white/20 appearance-none focus:outline-none focus:ring-0 focus:border-[#C8A96A] peer transition-colors" />
                <label htmlFor="phoneNumber" className="absolute text-[10px] tracking-[0.2em] font-semibold uppercase text-white/40 duration-300 transform -translate-y-4 top-5 z-10 origin-[0] peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-4 peer-focus:text-[#C8A96A]">Phone Number *</label>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <label htmlFor="googleMapsUrl" className="absolute text-[10px] tracking-[0.2em] font-semibold uppercase text-white/40 duration-300 transform -translate-y-4 top-5 z-10 origin-[0] peer-placeholder-shown:translate-y-0 peer-focus:-translate-y-4 peer-focus:text-[#C8A96A]">Google Maps URL</label>
            </div>
            ...
            <div className="bg-white/5 p-6 rounded-2xl border border-white/5">
              <label className="block text-[10px] uppercase tracking-[0.2em] text-white/60 mb-4 font-semibold">Amenities</label>
              <div className="flex space-x-4 mb-4">
                <input 
                  ...
                  className="flex-grow px-0 py-2 bg-transparent border-0 border-b border-white/20 text-white focus:border-[#C8A96A] focus:ring-0 outline-none placeholder-white/20" 
                  placeholder="E.g., Swimming Pool, Gym..." 
                />
                <button type="button" onClick={handleAddAmenity} className="px-6 py-2 bg-[#111] border border-white/10 rounded-xl hover:bg-white/10 transition-colors text-white text-[10px] tracking-[0.2em] font-bold uppercase">Add</button>
              </div>
            ...
            <div className="flex space-x-12 pt-2">
              <label className="flex items-center space-x-3 cursor-pointer group">
                ...
                <span className="text-sm font-light text-white/70 group-hover:text-white transition-colors">Published (Visible to public)</span>
              </label>
              ...
              <label className="flex items-center space-x-3 cursor-pointer group">
                ...
                <span className="text-sm font-light text-white/70 group-hover:text-white transition-colors">Featured on Home Page</span>
              </label>
            </div>
        ...
        <div className="p-8 border-t border-white/5 flex justify-between items-center relative z-20 bg-black/20">
          ...
          <div className="flex items-center space-x-4">
            <button type="button" onClick={onClose} className="px-8 py-3.5 text-white/50 hover:text-white font-['Inter'] text-[10px] uppercase tracking-[0.25em] font-semibold transition-colors hover:bg-white/5 rounded-xl">
              Cancel
            </button>
            <button form="project-form" type="submit" disabled={isLoading} className="px-10 py-3.5 bg-gradient-to-r from-[#C8A96A] to-[#E5D09C] text-black font-['Inter'] font-bold text-[10px] uppercase tracking-[0.3em] rounded-xl hover:shadow-[0_0_20px_rgba(200,169,106,0.3)] transition-all duration-300 disabled:opacity-50 disabled:grayscale flex items-center space-x-3 group">
              ...
              <span>{isLoading ? 'Saving...' : 'Save Residence'}</span>
              {!isLoading && <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="group-hover:translate-x-1 transition-transform"><polyline points="9 18 15 12 9 6"></polyline></svg>}
            </button>
          </div>
        </div>
      ...
      <ConfirmationModal
        ...
        message="Are you absolutely sure you want to delete this residence? This action is permanent and cannot be undone."
